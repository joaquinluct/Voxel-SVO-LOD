...
REGISTER_SERVICE_TYPE(TestingBasic2, "TestingBasic2");

struct VertexBasic2 {
    XMFLOAT3 position;
};

TestingBasic2::TestingBasic2() : m_cameraManager(), m_deviceManager(), m_inputLayout(), m_matrixBuffer(), m_pixelShader(), m_vertexBuffer(), m_vertexShader(), m_viewMatrix() {}
TestingBasic2::~TestingBasic2() {}
