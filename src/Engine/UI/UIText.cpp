...
//
//        // CORRECCIÓN: Inicializa Position y TexCoord con sus propias llaves,
...
void UIText::ApplyMaterial(ID3D11DeviceContext* context, std::shared_ptr<Material> m_material, XMMATRIX orthoMatrix) {
    ...
    // --- Usar WorldMatrixManager para establecer las matrices ---
    ...
    m_material->SetShaderParameters(context, worldIdentity, viewIdentity, orthoMatrix, 1);
}
