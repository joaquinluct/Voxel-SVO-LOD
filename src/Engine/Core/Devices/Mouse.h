...
#define NOMINMAX 
#include <windows.h>
#include "iRenderizable.h" // Necesario para implementar iRenderizable
#include "CameraManager.h" // Necesario para la clase Camera
...
{
public:
    Mouse(std::shared_ptr<CameraManager> cameraManager, HWND hwnd, int width, int height);
    ~Mouse();
