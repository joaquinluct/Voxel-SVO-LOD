...
public:
	...
	void SetShader(const std::string& shader) { prevPassData.shader = passData.shader; passData.shader = GetConfigStringValue(shader);
	}
	...
	void SetRasterizedState(const std::string& rasterizedState) { prevPassData.rasterizedState = passData.rasterizedState; passData.rasterizedState = GetConfigStringValue(rasterizedState); }
